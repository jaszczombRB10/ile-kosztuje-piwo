...
(function () {
  ...
  function renderMarkers() {
    ...
    if (countEl) {
      countEl.textContent = `${filtered.length} barów`;
    }
  ...
  },
  {
    "id": "kufle-i-kapsle",
    "name": "Kufle i Kapsle",
    "slug": "kufle-i-kapsle-nowogrodzka",
    "district": "Śródmieście",
