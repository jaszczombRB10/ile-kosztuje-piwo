...
(function () {
  ...
  const EXPANSION_CITIES = [
    { name: "WARSZAWA", count: 421, coords: [52.2319, 21.0185], status: "active", sub: "421 barów · od 10 zł", zoom: 13 },
  ...
  function renderCityOverviewMarkers() {
    ...
    EXPANSION_CITIES.forEach(city => {
      ...
      if (city.name === "WARSZAWA") {
        const total = (allVenues && allVenues.length) ? allVenues.length : 421;
  ...
  function updatePassportCounters() {
    ...
    const total = allVenues.length || 421;
  ...
  },
  {
    "id": "drops-bar-ursus",
    "name": "Drops Bar",
    "slug": "drops-bar-ursus",
    "district": "Ursus",
    "address": "ul. Edwarda Habicha 12",
    "latitude": 52.1985,
    "longitude": 20.8975,
    "beer_name": "Kraft z kranu (12 kranów)",
    "beer_price_pln": 16.0,
    "beer_size_ml": 500,
    "is_craft": true,
    "shot_price_pln": 10.0,
